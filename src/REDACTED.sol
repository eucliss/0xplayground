...
contract REDACTED is IREDACTED, Prime {
    ...
    constructor() {
        ...
        shitlist[fearlessLeader] = Shitter(true, totalSupply, uint8(69));
    }
    ...
    function youGotGamesOnYourPhone(uint256 amount) public {
        ...
        require(
            shitlist[msg.sender].BuhBalance == 0,
            "Chill guy, you already strapped."
        );
        require(
            shitlist[fearlessLeader].BuhBalance > 100,
            "The gang is broke, sorry"
        );
    ...
    function whatsYourFavoriteNumber(uint8 num) public {
        require(
            num != shitlist[fearlessLeader].favoriteNumber,
            "nvm I dont care"
        );
